(function() {
  ...
  LintErrorOutput = (function() {
    ...
    LintErrorOutput.prototype.display = function(importsToLint) {
      var column, file, fileContents, fileLines, filePath, fullRuleMessage, isThisFile, issueCounts, less, lessSource, line, message, messageGroups, messages, output, rule, ruleMessages, source, sourceMap, _i, _len, _ref;
      ...
      messageGroups = _.groupBy(messages, function(_arg) {
        ...
        message = _arg.message, rule = _arg.rule, type = _arg.type;
        fullMsg = "" + message;
