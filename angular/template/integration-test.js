...
like Peotractor, Selinium or PhantomJS to make their life easier, 
...
in a single command, and then execute all tests within a project when files change, 
or during the build process. Simply executing a command like grunt test can
 lint your code and peform all unit and integration tests. 
 Also take a look at Yeoman as a complete solution for setting
...
CasperJS - CasperJS is a navigation scripting & testing utility which uses headless browsers - PhantomJS.

When user stories are being created, it's a good idea to flesh out integration tests 
which will correspond to user journeys.
